...
-- at runtime using the environment variable tictactoe_bindir.
...
-- environment variable tictactoe_libdir.
...
-- using the environment variable tictactoe_dynlibdir.
...
-- runtime using the environment variable tictactoe_datadir.
...
-- using the environment variable tictactoe_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.4.8\\tictactoe-0.1.0.0-inplace-tictactoe"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.4.8"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.4.8\\tictactoe-0.1.0.0"
libexecdir = "C:\\cabal\\tictactoe-0.1.0.0-inplace-tictactoe\\x86_64-windows-ghc-9.4.8\\tictactoe-0.1.0.0"
